              ...
              <div class="card">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                    ...
                    <tbody>
                      <?php
                      $sql="select * from tblvisitor where CoArea = CoArea and remark IS NOT NULL ORDER BY id DESC";
                      ...
                      if($query->rowCount() > 0)
                      {
                        ...
                        { 
                          ...
                          <tr>
                            ...
                            <td class=""><?php  echo htmlentities($row->AddressBy ." ".$row->FullName);?></td>
                            <td class="text-center">0<?php  echo htmlentities($row->MobileNumber);?></td>
                            
                            <td class="text-center"><?php  echo htmlentities($row->Nic);?></td>
                            <td class="text-center"><?php  echo htmlentities($row->Electionseat);?></td>
