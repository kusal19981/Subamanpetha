      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body" >
                <a class="nav-link" href ="today_visitor.php" style="color: white">
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                <a class="nav-link" href ="dash_yesterday.php" style="color: white">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                <a class="nav-link" href ="dash_sevendays.php" style="color: white">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-primary card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                <a class="nav-link" href ="manage_visitor.php" style="color: white">   
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Total Visitors </h4>
          ...
          <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                <a class="nav-link" href ="approved.php" style="color: white">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Approved Visitors</h4>
                  <?php
                 
                  $query4=mysqli_query($con,"select ID from tblvisitor where remark = 0;");
                  $count_approved_visitors=mysqli_num_rows($query4);
                  ?>       
                  <h2 class="mb-5"><?php echo $count_approved_visitors?></h2>
                </a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white" style="height: 150px;">
                ...
                <a class="nav-link" href ="pending.php" style="color: white"> 
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Pending Visitors</h4>
                  <?php
                 
                  $query5=mysqli_query($con,"select ID from tblvisitor where remark IS NULL");
                  $count_pending_visitors=mysqli_num_rows($query5);
                  ?>       
                  <h2 class="mb-5"><?php echo $count_pending_visitors?></h2>
                </a>
                </div>
              </div>
            </div>
